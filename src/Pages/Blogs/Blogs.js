...
const Blogs = () => {
    return (
        <div>
            <div>
                <h2 className='text-center ' style={{ color: "orange" }}>Difference between javascript and nodejs</h2>
            ...
            <div>
                <h2 className='text-center ' style={{ color: "orange" }}> Differences between sql and nosql databases.</h2>
                <p style={{ marginLeft: "30px" }}>
            ...
            <div>
                <h2 className='text-center ' style={{ color: "orange" }}> When should you use nodejs </h2>
                <p style={{ marginLeft: "30px" }}>
                ...
                <p>
                    <h2 className='text-center ' style={{ color: "orange" }}>when should you use mongodb</h2>
                    <p style={{ marginLeft: "30px" }}>
